...
export default class SignupDto {
  @IsString({ message: 'Please enter a nickname' })
  @MinLength(1, { message: 'Please enter a nickname' })
  @MaxLength(20, { message: 'Nickname muse be no more than 20 characters long' })
